...
/// Local runtime selected for OpenHuman-managed lifecycle operations.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum LocalAiProvider {
    /// Ollama's native API and managed daemon.
    Ollama,
...
/// Normalizes common local-runtime aliases to their stable slugs.
...
/// Resolves the lifecycle-managed provider from a configured slug.
pub fn provider_from_name(provider: &str) -> LocalAiProvider {
...
pub fn endpoint_is_openai_v1(base_url: &str) -> bool {
...
/// (GH #5053).
pub fn model_discovery_api(provider: &str, base_url: &str) -> ModelDiscoveryApi {
