...
/// Stable message fragment emitted when provider resolution has no model id.
pub const NO_MODEL_CONFIGURED_ANCHOR: &str = "resolved to an empty model id";

/// Returns whether a provider response indicates invalid model configuration.
