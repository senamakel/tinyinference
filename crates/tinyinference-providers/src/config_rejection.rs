...
//! same class as budget exhaustion and must
...
//! the host observability classifier for the
...
/// helper exists so a host HTTP-layer wrapper can drop its
...
/// the host observability classifier.
