...
use crate::ollama::{
    OllamaPullEvent, OllamaPullProgress, OllamaPullRequest, ollama_base_url_from_override,
};
...
impl LocalAiService {
    pub(in crate::service) async fn ensure_models_available(
        &self,
        config: &Config,
    ) -> Result<(), String> {
    ...
    pub(in crate::service) async fn ensure_ollama_model_available(
        &self,
        config: &Config,
        model_id: &str,
        label: &str,
